...
namespace VertiGIS.Mobile.Samples.Samples.CustomSamples.Breadcrumbs
{
    class FakeLocationDataSource : LocationDataSource
    {
        ...
        private readonly MapPoint _circleRouteCenter = new MapPoint(-123.36494, 48.42629, SpatialReferences.Wgs84);
        ...
        public FakeLocationDataSource()
        {
            ...
            Polygon outerCircle = (Polygon)GeometryEngine.BufferGeodetic(_circleRouteCenter, 100, LinearUnits.Meters);
        ...
        private void TimerOnElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            this.UpdateLocation(new Esri.ArcGISRuntime.Location.Location(randomMapPoint, 5, 0, 0, false));
